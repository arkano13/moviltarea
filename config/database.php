...
class Database 
{
    ...
    {
        $this->host = isset($_ENV['DB_HOST']) ? $_ENV['DB_HOST'] : 'mysql.us.cloudlogin.co';
        $this->port = isset($_ENV['DB_PORT']) ? $_ENV['DB_PORT'] : '3306';
        $this->name = isset($_ENV['DB_NAME']) ? $_ENV['DB_NAME'] : 'ilsw_gelsyn';
        $this->user = isset($_ENV['DB_USER']) ? $_ENV['DB_USER'] : 'ilsw_gelsyn';
        $this->pass = isset($_ENV['DB_PASS']) ? $_ENV['DB_PASS'] : 'gelsynuth';
